...
.. note::
   This version of :mod:`lammps` module has different path than 
   :mod:`mdhandle.lammps` to the compiled LAMMPS extension due to its final 
   location after installation.  Otherwise both :mod:`lammps` moduldes 
   are identical.
...
class lammps:
  def __init__(self, args=None):
    ...
    # Different location than in mdhandle.lammps because this lammps.py
    # file will be located in the same directory as the _lammps_seria.so
